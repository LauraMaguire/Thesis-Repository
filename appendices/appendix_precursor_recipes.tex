...
\begin{table}[b!]
\centering
  \caption{Sample precursor soution recipe (10 wt \% PEG, 10 mg/mL nominal Nup concentration)}
...
\begin{table}[b!]
\centering
  \caption{Acrylamide hydrogel precursor stocks}
    \label{table:Irgacure}
    \begin{tabular}{p{5cm}p{4cm}p{5cm}}
      Component & Concentration & Buffer \\
\hline
...
\begin{table}[b!]
\centering
  \caption{Sample precursor soution recipe (6\% final acrylamide concentration)}
    \label{table:Irgacure-recipe}
    \begin{tabular}{p{5cm}p{5cm}}
      Stock & Amount \\
\hline
...
\begin{table}[b!]
\centering
  \caption{APS/TEMED chemical crosslinking tests}
    \label{table:APS}
