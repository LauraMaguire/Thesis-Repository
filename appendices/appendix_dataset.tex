...
\begin{SCfigure}
\caption{Parameters used to predict the bound diffusion constant for NTF2-F in FSFG hydrogels.  Binding data is from \cite{hayama18}.  \\}
\centering
...
\begin{figure}
\caption{Measured and calculated values for no-Nup hydrogels.}
\centering
...
\begin{figure}
\caption{Measured and calculated values for FSFG concat-1 hydrogels, nominally containing 10 mg/mL FSFG.}
\centering
...
\begin{figure}
\caption{Measured and calculated values for FSFG concat-2 hydrogels.}
\centering
