...
First, deep thanks to my advisor Loren Hough, who demonstrates that it's possible to combine thorough knowledge of physics, biology, theory, and experiment with remarkably supportive mentorship.  Loren's guidance and enthusiasm kept this project going, and I have gained immensely in both knowledge and skills along the way.  Meredith Betterton often acted as an unofficial advisor and got me un-stuck time and time again.  I also appreciate the advice and ideas from my remaining committee members, Matt Glaser, Noel Clark, and Franck Vernery.
...
Thanks go to current and former labmates Allison Holt, Jeffre Allen, Nabanita Das, and Amanda Burnett for years of help and advice.  I have similar appreciation for close collaborator Mike Stefferson, who gave me a much-needed crash course in computational physics while working on the modeling project.  Special gratitude goes to Kathryn Wall, without whose knowledge, patience, and wisdom I would never have lasted as a physicist learning biochemistry.  

I owe a great deal to Joe Falke and the CU/NIH biophysics training program, which jumpstarted me into biophysics and provided me with a valuable scientific community.  Generous hydrogel help came from Sadhana Sharma, Stephanie Bryant, Ben Fairbanks, Danielle Konetski, and Christopher Bowman.  Almost no data in this work would exist without the tireless assistance and advice of Annette Erbse of the BioFrontiers shared instrumentation core and Joe Dragavon of the shared microscopy core.  Thanks also to Jeeseong Hwang and Kim Briggman of NIST. 

Last but not least, thanks to my family and friends who have supported me unwaveringly throughout this endeavor.
