...
errorbar(peg.r1Avg,peg.r1AvgErr,'v',...
     'MarkerEdgeColor',[0.4940, 0.1840, 0.5560], ...
    'MarkerFaceColor',[0.4940, 0.1840, 0.5560],...
    'Color',[0.4940, 0.1840, 0.5560])
errorbar(pvp.r1Avg,pvp.r1AvgErr,'s',...
...
errorbar(fsfg.r2Avg,fsfg.r2AvgErr,'o',...
    'MarkerEdgeColor',[0, 0.4470, 0.7410], ...
    'MarkerFaceColor',[0, 0.4470, 0.7410])
errorbar(peg.r2Avg,peg.r2AvgErr,'v',...
    'MarkerEdgeColor',[0.4940, 0.1840, 0.5560], ...
    'MarkerFaceColor',[0.4940, 0.1840, 0.5560],...
    'Color',[0.4940, 0.1840, 0.5560])
errorbar(pvp.r2Avg,pvp.r2AvgErr,'s',...
        'MarkerEdgeColor',[0.4660, 0.6740, 0.1880], ...
    'MarkerFaceColor',[0.4660, 0.6740, 0.1880],...
    'Color',[0.4660, 0.6740, 0.1880])
hold off
...
errorbar(peg.r2Avg./peg.r1Avg,(peg.r2Avg./peg.r1Avg).*...
    sqrt((peg.r1AvgErr./peg.r1Avg).^2+(peg.r2AvgErr./peg.r2Avg).^2),'v',...
    'MarkerEdgeColor',[0.4940, 0.1840, 0.5560], ...
    'MarkerFaceColor',[0.4940, 0.1840, 0.5560],...
    'Color',[0.4940, 0.1840, 0.5560])
errorbar(pvp.r2Avg./pvp.r1Avg,(pvp.r2Avg./pvp.r1Avg).*...
    sqrt((pvp.r1AvgErr./pvp.r1Avg).^2+(pvp.r2AvgErr./pvp.r2Avg).^2),'s',...
    'MarkerEdgeColor',[0.4660, 0.6740, 0.1880], ...
    'MarkerFaceColor',[0.4660, 0.6740, 0.1880],...
    'Color',[0.4660, 0.6740, 0.1880])
hold off
