...
\begin{figure}
\caption[Recovery curves.]{Recovery curves for (A) no-Nup, (B) FSFG concat-1, and (C) FSFG concat-2 hydrogels.  All curves are shown for both NTF2-F and mCherry.  Dark lines are averaged curves.  Data normalized so that pre-bleach intensity is one.}
\centering
