...
The hydrogel nuclear pore mimics discussed in this chapter do not reproduce the selectivity properties of nuclear transport; the tethered Nup concentration is too low for a measurably selective material.  However, they do provide a platform from which to measure bound diffusion.  For both Nup lengths tested, non-zero values of bound diffusion in near agreement with our tethered-diffusion model were measured.  This represents a first step towards understanding the effect of bound diffusion on selective biofilters.
