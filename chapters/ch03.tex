...
\caption{Comparison of adjusted R-square goodness-of-fit value for one- and two- component exponential fits for (A) NTF2 and (B) mCherry accumulation fits.  Dotted line indicates no change between fits.  Points in the upper left fit better to a single exponential while points in the lower right fit better to a double exponential.}
\centering
