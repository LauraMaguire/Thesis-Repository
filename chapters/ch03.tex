...
We have access to a wide library of FSFG and FG124 variants, few of which I helped to create. Many originate in Loren's old lab (lookup), and others were created by Andrea Egan, Nick Bax, Eric Verbeke, and myself. Appendix~\ref{appx:sequences} provides the sequence of the most commonly-used Nup variants.
