...
We ran each simulation for $10^7$ time steps with $\delta t = 0.01$ $\mu$s, and recorded the transport factor's position every 100 time steps.  We calculated the mean-squared displacement $\ev{x^2}$ (MSD) of the transport factor and averaged it over 100 runs \figref[A]{fig:integrand}.  We then computed
\begin{equation}
